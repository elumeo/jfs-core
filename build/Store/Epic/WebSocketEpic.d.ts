...
declare const _default: import("redux-observable").Epic<PayloadAction<string, import("../Action").initializeApp.Payload> | import("typesafe-actions").EmptyAction<string> | import("typesafe-actions").EmptyAction<"config/LOAD"> | PayloadAction<string, import("../Action").ConfigLoaded.Payload> | PayloadAction<string, string> | PayloadAction<string, import("../Action").updateCredentials.Payload> | PayloadAction<string, import("../Action").checkLogin.Payload> | PayloadAction<string, INotificationContent> | PayloadAction<string, import("../../Types/Notification").INotification> | PayloadAction<string, number> | PayloadAction<string, import("../Action").RouteDetails> | PayloadAction<string, logout.Payload> | PayloadAction<string, authorizeSession.Payload> | PayloadAction<string, import("../Action").regionLoaded.Payload> | PayloadAction<string, import("../Reducer/Core/ToastReducer").IToastConfig> | PayloadAction<string, import("../Reducer/Core/WebSocketConnectionReducer").IWebSocketError> | PayloadAction<string, IWebSocketRoom<string>> | PayloadAction<string, IWebSocketRoomConnection> | PayloadAction<string, import("../../Jsc/Api").default.DTO.WebSocket.IWebSocketRoomUpdateDTO<any>>, PayloadAction<string, import("../Action").initializeApp.Payload> | import("typesafe-actions").EmptyAction<string> | import("typesafe-actions").EmptyAction<"config/LOAD"> | PayloadAction<string, import("../Action").ConfigLoaded.Payload> | PayloadAction<string, string> | PayloadAction<string, import("../Action").updateCredentials.Payload> | PayloadAction<string, import("../Action").checkLogin.Payload> | PayloadAction<string, INotificationContent> | PayloadAction<string, import("../../Types/Notification").INotification> | PayloadAction<string, number> | PayloadAction<string, import("../Action").RouteDetails> | PayloadAction<string, logout.Payload> | PayloadAction<string, authorizeSession.Payload> | PayloadAction<string, import("../Action").regionLoaded.Payload> | PayloadAction<string, import("../Reducer/Core/ToastReducer").IToastConfig> | PayloadAction<string, import("../Reducer/Core/WebSocketConnectionReducer").IWebSocketError> | PayloadAction<string, IWebSocketRoom<string>> | PayloadAction<string, IWebSocketRoomConnection> | PayloadAction<string, import("../../Jsc/Api").default.DTO.WebSocket.IWebSocketRoomUpdateDTO<any>>, import("../Reducer/Global").default.State, {}>;
