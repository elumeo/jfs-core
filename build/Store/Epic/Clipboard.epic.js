...
var handleCopy = function (action$) {
    return action$.pipe((0, operators_1.filter)((0, typesafe_actions_1.isActionOf)([Clipboard_action_1.copyToClipboard])), (0, operators_1.map)(function (_a) {
        var payload = _a.payload;
        return payload;
    }), (0, operators_1.switchMap)(function (payload) {
        return (0, rxjs_1.from)((0, EventHandler_api_1.copyToClipboard)(payload.text)).pipe((0, operators_1.switchMap)(function (_a) {
            var _b;
