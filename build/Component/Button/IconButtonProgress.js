...
var IconButtonProgress = (0, react_1.forwardRef)(function (props, ref) {
    ...
    return react_1.default.createElement("div", { style: ButtonProgress_1.wrapperStyles },
        ...
        inProgress && react_1.default.createElement(material_1.CircularProgress, { size: (0, ButtonProgress_1.mapToCircularProgressSize)(size), color: (0, ButtonProgress_1.mapToCircularProgressColor)(color), style: progressStyles }));
});
