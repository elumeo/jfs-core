...
var IconButtonProgressBase = (0, react_1.forwardRef)(function (props, ref) {
    ...
    return (react_1.default.createElement("div", { className: "button-progress__wrapper " + className },
        ...
        inProgress && (react_1.default.createElement(core_1.CircularProgress, { size: (0, ButtonProgressBase_1.mapToCircularProgressSize)(size), color: (0, ButtonProgressBase_1.mapToCircularProgressColor)(color), className: 'button-progress__progress' }))));
});
exports.default = (0, react_1.memo)(IconButtonProgressBase);
