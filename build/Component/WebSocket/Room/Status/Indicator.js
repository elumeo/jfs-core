...
var Indicator = function (_a) {
    ...
    return react_1.default.createElement(material_1.Tooltip, { title: formatMessage({ id: 'webSocket.room' }) + ': ' + roomName },
        react_1.default.createElement(material_1.Box, { width: Definition_1.default.spacing(2), height: Definition_1.default.spacing(2), borderRadius: '50%', borderColor: color, bgcolor: color }));
};
