...
const DatePicker = (_a) => {
    var { label, error = false, customClearButtonId, dateFormat, value, onChange, errorText, helperText = '', isClearable, textFieldProps } = _a, rest = __rest(_a, ["label", "error", "customClearButtonId", "dateFormat", "value", "onChange", "errorText", "helperText", "isClearable", "textFieldProps"]);
    ...
    useEffect(() => {
        var _a;
        (_a = document
            .getElementById(customClearButtonId)) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
