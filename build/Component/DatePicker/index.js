...
var DatePicker = function (_a) {
    ...
    var preparedInputProps = (0, react_1.useMemo)(function () { return (__assign(__assign({}, textFieldProps === null || textFieldProps === void 0 ? void 0 : textFieldProps.InputProps), { autoComplete: 'off', onFocus: function () { return shouldOpenOnFocus ? setOpen(true) : null; }, endAdornment: ((0, jsx_runtime_1.jsx)(material_1.IconButton, __assign({ disabled: disabled, size: 'small', onClick: toggleOpen }, { children: (0, jsx_runtime_1.jsx)(Today_1.default, {}) }))) })); }, [textFieldProps === null || textFieldProps === void 0 ? void 0 : textFieldProps.InputProps, shouldOpenOnFocus, disabled, setOpen, toggleOpen]);
    return ((0, jsx_runtime_1.jsx)(react_datepicker_1.default, __assign({ id: id, disabled: disabled, ref: datePickerRef, className: 'jfs-datepicker', popperClassName: 'jfs-datepicker__popper', dayClassName: function () { return 'jfs-datepicker__day'; }, monthClassName: function (d) { return 'jfs-datepicker__month--' + d; }, onClickOutside: toggleOpen, onChange: handleChangeValue, dateFormat: dateFormat || (0, mapLanguageToDateFormat_1.default)(language), locale: language, portalId: 'overlay', open: open, customInput: (0, jsx_runtime_1.jsx)(TextField_1.default, __assign({ color: color, hideClearButton: !isClearable || isPristine, required: rest.required }, textFieldProps, { InputProps: preparedInputProps, clearButtonProps: { id: clearButtonId } })) }, rest)));
};
