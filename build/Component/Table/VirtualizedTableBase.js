...
var VirtualizedTableBase = react_1.default.forwardRef(function (_a, ref) {
    ...
    var headerRenderer = function (headerProps) { return react_1.default.createElement(TableHeadDefault_1.default, { height: headerHeight, disableSort: headerProps.disableSort, sortBy: headerProps.sortBy, sortDirection: headerProps.sortDirection, label: headerProps.label, dataKey: headerProps.dataKey }); };
    return (react_1.default.createElement(react_virtualized_1.AutoSizer, { onResize: onResize }, function (_a) {
        var height = _a.height, width = _a.width;
        return (react_1.default.createElement(react_virtualized_1.Table, __assign({ ref: ref, height: height, width: width, rowClassName: getRowClassName, headerHeight: headerHeight, rowHeight: rowHeight, rowCount: rowCount, rowGetter: rowGetter, onRowClick: onRowClick, gridClassName: 'virtualized-table__grid' }, tableProps), columns.map(function (_a) {
            var dataKey = _a.dataKey, columnWidth = _a.width, other = __rest(_a, ["dataKey", "width"]);
            var finalWidth = (typeof columnWidth !== 'number')
                ? columnWidth(width)
                : columnWidth;
            return (react_1.default.createElement(react_virtualized_1.Column, __assign({ key: dataKey, headerStyle: { outline: 'none' }, headerRenderer: headerRenderer, className: 'virtualized-table__flex-container', cellRenderer: function (_a) {
...
exports.default = (0, react_1.memo)(VirtualizedTableBase);
