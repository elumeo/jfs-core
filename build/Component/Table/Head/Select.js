...
var Select = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(material_1.TableCell, __assign({ variant: 'head' }, rest, { children: loading
            ...
            : (0, jsx_runtime_1.jsx)(material_1.Checkbox, { sx: checkboxStyles, color: 'secondary', size: 'small', disabled: disabled, id: id, name: name, value: value, checked: checked, onChange: onChange }) })));
};
