...
var Default = function (_a) {
    ...
    var color = isActiveSort || !disableSort
        ...
        : 'inherit';
    var styles = (0, react_1.useMemo)(function () { return (__assign(__assign(__assign({}, (isActiveSort ? (0, exports.sortingStyles)(theme) : {})), { height: height, maxWidth: '100%', width: width }), sx)); }, [sortBy, isActiveSort, height, width, sx]);
