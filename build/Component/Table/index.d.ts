...
declare const Table: {
    ...
    VirtualizedTable: <ItemData extends {}, ItemContext = unknown>({ data, sortBy, sortDirection, compare, filter, slotProps, components, isLoading, ...props }: import("./VirtualizedTable").Props<ItemData, ItemContext>) => JSX.Element;
};
