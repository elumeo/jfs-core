...
declare const Table: {
    Cell: {
        DateTime: import("react").MemoExoticComponent<({ value, noValueElement, asTwoLines, displayTime, ...rest }: import("./Cell/DateTime").Props) => import("react/jsx-runtime").JSX.Element>;
    ...
    Table: (props: import("@mui/material").TableProps<"table", {}>) => import("react/jsx-runtime").JSX.Element;
    VirtualizedTable: <ItemData extends {}, ItemContext = unknown>({ data, sortBy, sortDirection, compare, filter, tableProps, tableRowProps, components: propComponents, ...props }: import("./VirtualizedTable").Props<ItemData, ItemContext>) => import("react/jsx-runtime").JSX.Element;
};
