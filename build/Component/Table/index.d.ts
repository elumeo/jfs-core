...
declare const Table: {
    ...
    VirtualizedTable: <ItemData extends {}>({ data, sortBy, sortDirection, compare, filter, tableProps, tableRowProps, ...props }: import("./VirtualizedTable").Props<ItemData>) => JSX.Element;
};
