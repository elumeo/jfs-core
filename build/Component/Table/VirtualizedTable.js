...
var VirtualizedTable = function (_a) {
    ...
    var components = react_1.default.useMemo(function () { return (__assign({ EmptyPlaceholder: (data.length == 0 && !isLoading)
        ...
        }), TableBody: react_1.default.forwardRef(function (_props, ref) { return (0, jsx_runtime_1.jsx)(material_1.TableBody, __assign({}, _props, { ref: ref })); }), TableFoot: react_1.default.forwardRef(function (_props, ref) { return (0, jsx_runtime_1.jsx)(Footer_1.default, __assign({ isLoading: isLoading }, _props, { ref: ref })); }) }, propComponents)); }, [propComponents, slotProps, isLoading]);
