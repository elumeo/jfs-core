...
var ProductImage = function (_a) {
    ...
    return mediaUri ? react_1.default.createElement("img", { src: mediaUri, alt: id, style: styles }) : react_1.default.createElement(NoProductImageAvailable_1.default, null);
};
