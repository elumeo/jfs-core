...
var tableCellStyles = { padding: '4px', justifyContent: 'center' };
var TableCellSelect = function (_a) {
    ...
    return react_1.default.createElement(TableCellRoot_1.default, { styles: tableCellStyles, height: height },
        react_1.default.createElement(material_1.Checkbox, { style: checkboxStyles, size: 'small', id: id + value, name: name, value: value !== null && value !== void 0 ? value : '', checked: checked, disabled: disabled, onChange: onChange }));
};
