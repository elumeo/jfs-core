...
var AppCardHeader = function (_a) {
    ...
    var buildRefreshButton = function () {
        return (react_1.default.createElement(core_1.Grid, { item: true },
            react_1.default.createElement(core_1.IconButton, { color: refreshButtonColor, classes: { root: classes.refreshButtonRoot }, size: refreshButtonSize, disabled: isLoading, onClick: onRefresh },
    ...
    var headerTitle = (react_1.default.createElement(react_1.default.Fragment, null,
        isLoading && (react_1.default.createElement(core_1.LinearProgress, { className: classes.progress, color: 'secondary' })),
    ...
    return (react_1.default.createElement(core_1.CardHeader, { className: classes.cardHeaderRoot, subheader: subtitle, title: headerTitle, action: action }));
};
