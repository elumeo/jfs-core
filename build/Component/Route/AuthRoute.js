...
const AuthRoute = props => {
    ...
    return isAuthorized ? (React.createElement(BaseRoute, Object.assign({}, props))) : isCheckingSession ? (React.createElement(CircularProgress, { id: 'check-session-progress' })) : (React.createElement(React.Fragment, null));
};
