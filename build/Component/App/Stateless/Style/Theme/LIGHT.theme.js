...
var LightPalette = __assign({ primary: Color.primary, secondary: Color.apatith, warning: Color.warning, error: Color.error, success: Color.success, info: Color.info, grey: colors_1.grey, mode: 'light', common: Color.common, text: {
...
var LIGHT = (0, styles_1.createTheme)({
