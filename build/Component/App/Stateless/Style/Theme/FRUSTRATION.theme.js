...
var FRUSTRATION = (0, styles_1.createTheme)({
    palette: __assign({ primary: Color.quarz, secondary: Color.quarz, warning: Color.warning, error: Color.error, success: Color.success, info: Color.info, mode: 'dark', grey: colors_1.grey, common: Color.common, text: {
