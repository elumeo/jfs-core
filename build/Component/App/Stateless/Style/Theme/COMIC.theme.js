...
var comicPalette = __assign(__assign({}, Color), { primary: Color.info, secondary: Color.warning, mode: 'light', grey: colors_1.grey, common: Color.common, text: {
...
var COMIC = (0, styles_1.createTheme)({
