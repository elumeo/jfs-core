...
var CustomInput = function (_a) {
    var _b = _a.variant, variant = _b === void 0 ? 'standard' : _b, label = _a.label, onClear = _a.onClear, canClear = _a.canClear, inputProps = __rest(_a, ["variant", "label", "onClear", "canClear"]);
    var Determined = react_1.default.useMemo(function () { return inputComponentByVariant(variant); }, [variant]);
    return react_1.default.createElement(Determined, __assign({ label: label, endAdornment: canClear
