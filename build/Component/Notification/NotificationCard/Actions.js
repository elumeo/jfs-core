...
const Actions = ({ intl: { formatMessage }, notification, ref }) => {
    ...
    if (dismissButtonVisible !== false) {
        actions.push(React.createElement(DismissButton, { ref: ref, notification: notification, onClick: onDismiss }));
    }
    if (hideButtonVisible !== false) {
        actions.push(React.createElement(HideButton, { ref: ref, notification: notification, onClick: onHide }));
    }
    if (!!onCustomAction) {
        actions.push(React.createElement(CustomActionButton, { notification: notification, iconName: customActionIconName, tooltipLabel: customActionTooltipTranslationId
                ...
                : undefined, ref: ref, onClick: onCustomAction }));
    }
