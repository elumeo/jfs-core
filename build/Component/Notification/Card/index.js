...
const Card = ({ children, notification, temporary }) => {
    ...
    return (React.createElement(MUICard, { style: {
        ...
        React.createElement(CardHeader, { avatar: React.createElement(Icon, { variant: notification.variant }), title: React.createElement(Typography, { component: 'h4' }, notification.title), subheader: React.createElement(Typography, { component: 'h6' }, notification.subtitle), subheaderTypographyProps: { color: 'inherit' }, action: React.createElement(CardActions, null,
                notification.action
