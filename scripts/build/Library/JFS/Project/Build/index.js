...
exports.watch = exports.single = exports.compile = exports.synchronize = exports.equalize = exports.run = void 0;
...
exports.run = run;
const equalize = (path) => __awaiter(void 0, void 0, void 0, function* () {
    const src = path_1.resolve(path, 'src');
    const build = path_1.resolve(path, 'build');
    const paths = yield recursive_readdir_1.default(src, ['*.ts', '*.tsx']);
    const copied = [];
    if (paths.length) {
        paths.map((path) => __awaiter(void 0, void 0, void 0, function* () {
            const virtual = path.substring(src.length);
            yield fs_extra_1.default.copyFile(path, path_1.resolve(build, Text.Prefix.remove(virtual, path_1.sep)));
            copied.push(path);
