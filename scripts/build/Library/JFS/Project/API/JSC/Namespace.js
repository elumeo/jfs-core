...
exports.generate = exports.DTO = void 0;
const Render = __importStar(require("../Render"));
const DTO = __importStar(require("../Render/JSC/DTO"));
exports.DTO = __importStar(require("../Render/JSC/DTO"));
const generate = ({ name, remote }) => Render.TypeScript.namespace({
    name,
