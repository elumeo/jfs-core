...
exports.last = exports.View = exports.Asset = exports.CSV = exports.HTML = exports.Version = exports.File = void 0;
...
const last = (base) => __awaiter(void 0, void 0, void 0, function* () {
    return ({
        version: yield Version.last(base),
        asset: yield Asset.restore(base)
    });
});
exports.last = last;
