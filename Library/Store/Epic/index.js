...
export const wrappedCombineEpics = (...epics) => combineEpics(LoginEpic, NotificationEpic, AppEpic, SystemEpic, ConfigurationEpic, SessionEpic, LanguageEpic, WebSocketEpic, ...epics, Shared.Epic());
