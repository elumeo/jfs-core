...
const sxs = {
  icon: {
    ...
    color: definition.colorSchemes.light.palette.secondary.main
  }
}
        ...
        <CardContent>
          ...
          <Box mt={2}>
            ...
            <CodeBox>
              ...
              <Box pl={2} component={Typography}>{`color: definition.colorSchemes.light.palette.secondary.main`}</Box>
            ...
            <List>
              ...
              <ListItem>
                <ListItemAvatar>
                  <BadgePercentIcon style={{ fontSize: definition.typography.pxToRem(32), color: definition.colorSchemes.light.palette.secondary.main }} />
                </ListItemAvatar>
                <ListItemText><CodeBox component={'span'}
                  size={'small'}>{`<BadgePercentIcon style={{ fontSize: definition.typography.pxToRem(32), color :definition.colorSchemes.light.palette.secondary.main }} />`}</CodeBox></ListItemText>
              </ListItem>
              <ListItem>
                <ListItemAvatar>
          ...
          <Box mt={2}>
            ...
            <Box mt={1}>
              <Grid container spacing={1}>
                <Grid item><BadgePercentIcon style={iconColor === 'reactMd' ? { color: `${definition.colorSchemes.light.palette.common.black}80` } : null} /></Grid>
