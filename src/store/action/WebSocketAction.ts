...
import { IWebSocketJoiningRoom, IWebSocketJoinRoom, IWebSocketRoom } from '../reducer/WebSocketReducer';
...
export const webSocketJoinRoomRequestAction = createStandardAction(featureName + '/JOIN_ROOM_REQUEST')<IWebSocketJoinRoom>();
export const webSocketJoinRoomLoadingAction = createStandardAction(featureName + '/JOIN_ROOM_LOADING')<IWebSocketJoiningRoom>();
export const webSocketJoinRoomSuccessAction = createStandardAction(featureName + '/JOIN_ROOM_SUCCESS')<IWebSocketJoiningRoom>();
