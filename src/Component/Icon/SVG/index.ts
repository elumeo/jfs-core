...
export { default as PayPalColor } from 'Component/Icon/SVG/PayPalColor';
export { default as PayPal } from 'Component/Icon/SVG/PayPal';
export { default as PhoneBlock } from './PhoneBlock';
export { default as RatePay } from './RatePay';
export { default as RatePayColor } from './RatePayColor';
