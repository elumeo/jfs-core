...
const Header: React.FC<AppCardHeaderBaseProps> = ({
  ...
  <LinearProgress color='secondary' sx={isLoading ? {} : hiddenStyle}/>
  <CardHeader
    subheader={subtitle}
    action={action}
    disableTypography
    title={<>
      <Stack direction={'row'} spacing={1} alignItems={'center'}>
        ...
        {onRefresh !== null && <RefreshButton color={refreshButtonColor} size={refreshButtonSize} inProgress={isLoading} onClick={onRefresh}/>}
      </Stack>
    </>}
  />
</>;
