...
const TextFieldClearButton = ({ onChange, clearButtonSize = 'small', clearIconSize = 'small', variant = 'standard', InputProps, ...rest }: TextFieldClearButtonProps) => {
  ...
  const getIconButtonPadding = () => clearButtonSize === 'medium' ? 12 : 6;
  ...
  const endAdornmentClearButton = showClearButton && (
    <IconButton size={clearButtonSize} disabled={rest.disabled} color={'secondary'} onClick={() => handleOnChange(null)} style={{ padding: getIconButtonPadding() }}>
